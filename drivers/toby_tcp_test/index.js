...
exports.createDevice = base => {
  ...
  function onFrame(data) {
    ...
    match = data.match(/setG,OK,(.*)\n/)
    if (match) {
      base.getVar('Green').value = parseInt(match[1])
      base.commandDone()
      return
    }
    
    match = data.match(/setB,OK,(.*)\n/)
    if (match) {
      base.getVar('Blue').value = parseInt(match[1])
      base.commandDone()
      return
    }
  ...
  function recallPreset(params) {
    base.getVar('Presets').string = params.Value
    sendDefer(`${params.Name},${params.Value}\n`)
  }
